...
#define PIN_I2C1_SCL     	GPIO_PIN_8  //PB8

#ifdef STM32L433xx
#define V2_IRQ_PIN			GPIO_PIN_2
#define PIN_I2C1_SDA		GPIO_PIN_7  //PB7
#else
#define V2_IRQ_PIN          GPIO_PIN_0
#define PIN_I2C1_SDA		GPIO_PIN_9  //PB9
#endif

#ifdef STM32L433xx
	#define V1_IRQ EXTI15_10_IRQn
	#define V2_IRQ EXTI2_IRQn
#else
...
static void _I2cFailRecover(){
    ...
    // Enable I/O
    __GPIOB_CLK_ENABLE();
    HAL_GPIO_WritePin(GPIOB, PIN_I2C1_SCL, GPIO_PIN_SET);
    HAL_GPIO_WritePin(GPIOB, PIN_I2C1_SDA, GPIO_PIN_SET);
    ...
    do{
        for( i=0; i<10; i++){
            HAL_GPIO_WritePin(GPIOB, PIN_I2C1_SCL, GPIO_PIN_RESET);
            HAL_Delay(1);
            HAL_GPIO_WritePin(GPIOB, PIN_I2C1_SCL, GPIO_PIN_SET);
            HAL_Delay(1);
        }
//        if( HAL_GPIO_ReadPin(GPIOB, PIN_I2C1_SDA) == 0 ){
//            static int RetryRecover;
//            RetryRecover++;
//        }
    }while(HAL_GPIO_ReadPin(GPIOB, PIN_I2C1_SDA) == 0 && nRetry++<7);
...
void XNUCLEO6180XA1_I2CFailRecover(){
	_I2cFailRecover();
}
...
static void _V2_GPIO_Init(){
    ...
    /*Configure GPIO pins interrupt pA12 = INTR */
    GPIO_InitStruct.Pin = GPIO_PIN_12 ;
    GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    //TODO: Enable INTL if implemented (otherwise it's used for LED:LD4) //
    /* PB13 = INTL */
    /*
    GPIO_InitStruct.Pin = GPIO_PIN_13;
    GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
